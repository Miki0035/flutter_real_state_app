...
class MDetailScreen extends StatelessWidget {
  MDetailScreen({super.key, required this.propertyId});
      ...
      body: Consumer<DatabaseRepository>(
        builder: (_, dbRepo, __) {
          return FutureBuilder(
            future: dbRepo.getPropertyId(propertyId),
            builder: (context, snapshot) {

              final property = dbRepo.propertyDetail;
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      MApartmentAgentContainer(
                                        ...
                                        agentName: property.agent.toString(),
                                        relation: "Owner",
                                      ),
                                      const Expanded(
                                        flex: 2,
